...
public class Metadata {
	...
	/**
	 * The datafiles key contains a list of file paths, which can be relative or
	 * complete URLs. These files contain additional information related to the
	 * returned object and can be retrieved by a subsequent call. The empty list
	 * should be returned if no additional data files are present.
	 * 
	 * @return datafiles
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.datafiles, metadata.datafiles)
				&& Objects.equals(this.pagination, metadata.pagination) && Objects.equals(this.status, metadata.status);
	}
